...
public class PriceMatchTest2 {

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		ReadJSonFile<Product> productReader = new ReadJSonFile<Product>("src/test/resources/canonProduct.txt", Product.class);
...
//		productContainer.setUnmathcedStatisObject(umatchedStatis);
		...
		ReadJSonFile<Price> priceReader = new ReadJSonFile<Price>("src/test/resources/canonPrice.txt", Price.class);
...
//		priceProcessor.setUnmathcedStatisObject(umatchedStatis);
		...
		WriteJSonFile listingsWriter = new WriteJSonFile("output/cannon_product_listings.txt");
